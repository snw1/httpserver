...
#ifndef HTTP_HTTPNOTFOUNDRESPONSE_H
#define HTTP_HTTPNOTFOUNDRESPONSE_H
 ...
 * \brief HTTP 404 Not Found response class
 */
class HTTPNotFoundResponse : public HTTPResponse
{
public:
    /**
     * Constructor
     ...
     * Destructor
     */
    virtual ~HTTPNotFoundResponse();
};

}

#endif // HTTP_HTTPNOTFOUNDRESPONSE_H
