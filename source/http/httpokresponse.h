...
#ifndef HTTP_HTTPOKRESPONSE_H
#define HTTP_HTTPOKRESPONSE_H
 ...
 * \brief HTTP 200 OK response class
 */
class HTTPOKResponse : public HTTPResponse
{
public:
    /**
     * Constructor
     */
    HTTPOKResponse(const std::string &contents);
    /**
     * Destructor
     */
    virtual ~HTTPOKResponse();
};

}

#endif // HTTPSERVER_HTTPOKRESPONSE_H
